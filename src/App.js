  ...
  return (
    ...
    >
      ...
      <Category name="Temi Skill" colour="300">
        ...
        <Block type="openwebsite"></Block>
        <Block type="movement_turn"></Block>
        <Block type="tilt_head"></Block>
        <Block type="movement_direction"></Block>
        <Block type="locations_go_home"></Block>
        <Block type="movement_turn2"></Block>
        <Block type="movement_tilt2"></Block>
